...
; 0000 000F CLKPR = 0x00;
	...
	STS  97,R30
; 0000 0010 
; 0000 0011 DDRD = 0b01000000;
	LDI  R30,LOW(64)
	OUT  0xA,R30
; 0000 0012 PORTD = 0b10111111;
	LDI  R30,LOW(191)
	OUT  0xB,R30
; 0000 0013 
; 0000 0014 // Configure for Timer 0 as a counter in pin T0(PD4)
; 0000 0015 TCCR0A = 0b10000001;
	LDI  R30,LOW(129)
	OUT  0x24,R30
; 0000 0016 TCCR0B = 0b00000101;            //Clock timer = clockIO/1024
	LDI  R30,LOW(5)
	OUT  0x25,R30
